...
import { createSSEConnection, type ConnectionState } from "@/lib/sse-connection";
...
const EVENT_TYPES = [
  "connected", "session:added", "session:updated", "session:removed",
  "pod:formed", "pod:updated", "pod:dissolved",
  "cluster:created", "cluster:updated", "cluster:deleted",
  "cluster:reordered", "cluster:assignment-changed", "heartbeat",
];
