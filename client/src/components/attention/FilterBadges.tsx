...
const FILTER_CONFIGS: FilterBadgeConfig[] = [
	{
		...
		activeColor:
			"bg-activity-pending-approval/20 border-activity-pending-approval text-activity-pending-approval",
	...
	},
	{
		...
		label: "Running Tool",
		activeColor:
			"bg-activity-running-tool/20 border-activity-running-tool text-activity-running-tool",
	...
	},
	{
		...
		label: "Processing",
		activeColor:
			"bg-activity-processing/20 border-activity-processing text-activity-processing",
