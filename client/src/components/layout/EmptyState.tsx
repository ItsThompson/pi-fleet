	...
	return (
		<div className="flex flex-col items-center justify-center h-full text-center px-8">
			...
			<p className="text-sm text-muted-foreground max-w-md">
				Sessions will appear here when pi is running with the pi-fleet extension
				installed. Start a pi session in your terminal to get started.
			</p>
			<div className="mt-6 bg-secondary/50 border rounded-lg p-4 max-w-md text-left">
				...
				<p className="text-[10px] text-muted-foreground/70 mt-2">
					New pi sessions will automatically register after installation. No
					restart required.
				</p>
			</div>
		</div>
